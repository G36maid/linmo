...
setup_toolchain() {
	...
	*)
	...
	local url="${TOOLCHAIN_REPO}/releases/download/${TOOLCHAIN_VERSION}/riscv32-elf-${TOOLCHAIN_OS}-${compiler_name}-nightly-${TOOLCHAIN_VERSION}-nightly.tar.xz"
